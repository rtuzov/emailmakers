...
async function testOpenAIAgent() {
  ...
  try {
    ...
    // 🎯 Тестовый запрос
    const request = 'Проанализируй email кампанию для осенних путешествий в Норвегию. Целевая аудитория - путешественники 25-45 лет. Цель - увеличить продажи туров на 20%.';
