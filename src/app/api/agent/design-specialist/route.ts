...
export async function POST(request: NextRequest) {
  try {
    ...
    // ✅ FAIL FAST: Content package is required, no hardcoded defaults allowed
    if (!content_package || !content_package.content) {
      return NextResponse.json({
        success: false,
        error: 'Content package is required. Please provide actual content generated by content specialist.',
