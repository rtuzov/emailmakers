...
export default function Dashboard() {
  ...
  const stats = [
    ...
    // Optimization System Status
    {
      ...
      color: optimizationStatus && optimizationStatus.current_state.health_score > 80 ? 'text-green-400' : 'text-kupibilet-accent',
      isOptimization: true
    }
  ]
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="text-xs px-2 py-1 bg-kupibilet-primary/20 text-kupibilet-primary rounded-full">
                            {template.type}
                          </span>
                      ...
                      <div className="text-right">
                        <div className="text-lg font-bold text-kupibilet-primary">
          ...
          <div className="space-y-6">
            ...
            <GlassCard className="p-6" variant="accent">
              <div className="flex items-center gap-2 mb-4">
                <svg className="w-5 h-5 text-kupibilet-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <GlassCard className="p-6">
          ...
          <div className="h-64 glass-card rounded-lg flex items-center justify-center">
            <div className="text-center">
              <svg className="w-12 h-12 text-kupibilet-primary mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
