...
- Orchestrator создает уникальную папку кампании (например: `campaigns/campaign_1752067390491_6bw26vhgh4e`)
- Этот путь передается вам через context или handoff
- Используйте этот реальный путь вместо placeholder-ов в ваших tool calls
- **НИКОГДА не используйте хардкодированные пути типа "campaign_path_из_контекста"**

**Пример корректного использования:**
```
// ПРАВИЛЬНО - используйте реальный campaign_path из context
save_analysis_result({
  // ... other params ...
  campaign_path: "/Users/rtuzov/PycharmProjects/Email-Makers/campaigns/campaign_1752067390491_6bw26vhgh4e"
})

// НЕПРАВИЛЬНО - не используйте placeholders!
save_analysis_result({
  // ... other params ...
  campaign_path: "campaign_path_из_контекста"  // ❌ НЕ ДЕЛАЙТЕ ТАК!
})
```
