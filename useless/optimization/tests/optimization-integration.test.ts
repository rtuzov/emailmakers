...
// Mock dependencies
jest.mock('../optimization-engine');
jest.mock('../../monitoring/validation-monitor');
jest.mock('../../../shared/infrastructure/monitoring/metrics-service');
...
describe('OptimizationIntegration', () => {
  ...
  beforeEach(() => {
    ...
    mockValidationMonitor.getMetrics = jest.fn().mockReturnValue(createMockValidationMetrics());
    (ValidationMonitor.getInstance as any) = jest.fn().mockReturnValue(mockValidationMonitor);

    // Setup mock MetricsService
    mockMetricsService = {
      getSnapshot: jest.fn().mockReturnValue(createMockInfrastructureMetrics()),
      incrementCounter: jest.fn(),
      recordDuration: jest.fn(),
      setGauge: jest.fn()
    } as any;
    (MetricsService as any) = jest.fn().mockImplementation(() => mockMetricsService);

    // Setup mock OptimizationEngine
    mockOptimizationEngine = {
      analyzeSystemPerformance: jest.fn(),
    ...
    (OptimizationEngine as any) = jest.fn().mockImplementation(() => mockOptimizationEngine);
  ...
  describe('Integrated Metrics Collection', () => {
    ...
    test('should handle metrics collection errors gracefully', async () => {
      ...
      mockValidationMonitor.getMetrics = jest.fn().mockImplementation(() => {
  ...
  describe('Optimization Analysis', () => {
    test('should perform full optimization analysis', async () => {
      ...
      mockOptimizationEngine.analyzeSystemPerformance = jest.fn().mockResolvedValue(mockAnalysis);
  ...
  describe('Optimization Recommendations', () => {
    test('should get optimization recommendations', async () => {
      ...
      mockOptimizationEngine.analyzeSystemPerformance = jest.fn().mockResolvedValue({} as any);
      mockOptimizationEngine.generateOptimizations = jest.fn().mockResolvedValue(mockRecommendations);
    ...
    test('should emit recommendations_generated event', async () => {
      mockOptimizationEngine.analyzeSystemPerformance = jest.fn().mockResolvedValue({} as any);
      mockOptimizationEngine.generateOptimizations = jest.fn().mockResolvedValue([]);
  ...
  describe('Optimization Application', () => {
    test('should generate and apply safe optimizations', async () => {
      ...
      mockOptimizationEngine.analyzeSystemPerformance = jest.fn().mockResolvedValue({} as any);
      mockOptimizationEngine.generateOptimizations = jest.fn().mockResolvedValue(mockRecommendations);
      mockOptimizationEngine.applyOptimizations = jest.fn().mockResolvedValue(mockResults);
    ...
    test('should emit optimizations_applied event', async () => {
      ...
      (integration as any).canApplyMoreOptimizations = jest.fn().mockReturnValue(true);
      (integration as any).filterRecommendationsBySafetyPolicy = jest.fn().mockReturnValue([{}]);
  ...
  describe('Event Handling', () => {
    test('should trigger analysis on critical events', async () => {
      const performFullOptimizationAnalysisSpy = jest.spyOn(integration, 'performFullOptimizationAnalysis').mockResolvedValue({} as any);
    ...
    test('should reset daily counters at midnight', async () => {
      ...
      const mockDate = jest.fn(() => ({
        toDateString: jest.fn().mockReturnValue('2023-12-02')
      }));
  ...
  describe('Error Handling', () => {
    ...
    test('should handle optimization errors gracefully', async () => {
      ...
      mockOptimizationEngine.analyzeSystemPerformance = jest.fn().mockRejectedValue(new Error('Analysis failed'));
    ...
    test('should emit optimization_error event on failures', async () => {
      mockOptimizationEngine.analyzeSystemPerformance = jest.fn().mockRejectedValue(new Error('Test error'));
